...
pub const LAYER_DIMENSIONS: [[usize; 2]; 3] = [[INPUT_SIZE, 128], [128, 16], [16, 1]];
...
impl Default for Model {
    fn default() -> Self {
        let input_layer = EfficentlyUpdatableDenseLayer::new(ACCUMULATOR_INPUT_SIZE);
...
impl Model {
    ...
    pub fn load_from_file(&mut self, file_path: &str) {
        ...
        self.input_layer.get_mut_layer().set_weights(weights_array);
        ...
        println!("Biases: {:?}", biases_array);
        self.input_layer.get_mut_layer().set_biases(&biases_array);
